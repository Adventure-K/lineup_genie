...
const encryptPassword = (password) => {
  ...
  return hashSync(password, '$2b$10$p5Wkte33hlOBOcUtJie6H.'); // hash passwords for each user.
  return password;
};
...
const comparePassword = (candidatePassword, storedPassword) => {
  ...
  */
  return compareSync(candidatePassword, storedPassword); // allow checking hashed passwords for match
